...
@php
    ...
    // Safety: if controller forgot to filter, ensure we only show usable categories here
...
<div class="max-w-xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
    ...
    {{-- If current category is no longer usable, warn the user --}}
    @if(!$currentUsable)
            ...
            <div class="flex items-start gap-2">
                ...
                <div class="text-sm text-amber-800 dark:text-amber-200">
                    ...
                    <p class="mt-1">
                        ...
                        isn’t usable for products. Please select an active category with kind
        ...
        <form action="{{ route('products.update', $product) }}" method="POST" class="space-y-6">
            ...
            <div>
                ...
                <input id="name" type="text" name="name"
                       ...
                       required class="form-input w-full" placeholder="e.g. Coca-Cola 500ml">
                @error('name')
            ...
            <div x-data="{ q: '' }">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    Need a new one? <a href="{{ route('categories.create', ['kind'=>'product']) }}" class="text-indigo-600 dark:text-indigo-400 hover:underline">Create category</a>.
                </p>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input id="price" type="number" step="0.01" min="0"
                           ...
                           required class="form-input w-full" placeholder="e.g. 1200">
                    @error('price')
                        <p class="text-red-600 dark:text-red-400 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div>
                    ...
                    <input id="stock" type="number" step="1" min="0"
                           name="stock" value="{{ old('stock', $product->stock) }}"
                           required class="form-input w-full">
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                        Changing this value will create a stock <span class="font-medium">adjustment</span>
